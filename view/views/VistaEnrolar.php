...
<main class="main-content flex-grow-1 p-4 p-md-5 overflow-auto">
    <div class="header-seccion d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="fs-3 fw-bold mb-1">Enrolamiento de Funcionario</h1>
            <p class="mb-0 fs-6">Registra un nuevo trabajador y genera su credencial de acceso.</p>
        </div>
        <a href="VistaAsistencia.php" class="btn btn-light fw-bold shadow-sm text-dark">
